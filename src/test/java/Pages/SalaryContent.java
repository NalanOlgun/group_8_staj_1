...
public class SalaryContent extends _Parent {
    WebElement myElement;


    public SalaryContent() {
        PageFactory.initElements(driver, this);
    }

    @FindBy (xpath = "//ms-add-button[contains(@tooltip,'MODIFIER.TITLE')]//button")
    private WebElement addSalModButton;
    ...
    public void findElementAndClickFunction(String ElementName) {
        ...
        switch (ElementName){
            case "addSalModButton":
                myElement = addSalModButton;
                break;
